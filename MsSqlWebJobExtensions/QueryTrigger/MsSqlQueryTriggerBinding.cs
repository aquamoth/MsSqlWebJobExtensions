...
{
    class MsSqlQueryTriggerBinding : ITriggerBinding
    {
        ...
        public MsSqlQueryTriggerBinding(string configuration, ParameterInfo parameter, MsSqlQueryTriggerAttribute attribute)
        {
        ...
        public Task<IListener> CreateListenerAsync(ListenerFactoryContext context)
        {
            ...
            IListener listener = new MsSqlQueryListener(_configuration, context.Executor, _attribute);
