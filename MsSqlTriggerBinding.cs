...
{
    class MsSqlTriggerBinding : ITriggerBinding
    {
        ...
        public MsSqlTriggerBinding(string configuration, ParameterInfo parameter, MsSqlTriggerAttribute attribute)
        {
        ...
        public Task<IListener> CreateListenerAsync(ListenerFactoryContext context)
        {
            ...
            IListener listener = new MsSqlListener(_configuration, context.Executor, _attribute);
